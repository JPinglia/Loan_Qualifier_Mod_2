"""Helper functions to intialize app.py
1) Loading bank data
2) Getting applicant info
3) Find qualifying loans

These functions are called as required by app.py to help faciliate the lone qualification process.
